...
var game = {
	...
	init: function(){
		...
		game.backgroundMusic = loader.loadSound('audio/sonido');

		game.slingshotReleasedSound = loader.loadSound("audio/released");
		game.bounceSound = loader.loadSound('audio/golpe');
		game.breakSound = {
	...
	data:[
	 {   // First level 
		...
		entities:[
			...
			{type:"block", name:"wood", x:520,y:380,angle:90,width:100,height:25},
			{type:"block", name:"glass", x:520,y:280,angle:90,width:100,height:25},								
			{type:"villain", name:"sodaglass",x:520,y:205,calories:590},

			{type:"block", name:"wood", x:620,y:380,angle:90,width:100,height:25},
			{type:"block", name:"glass", x:620,y:280,angle:90,width:100,height:25},								
			{type:"villain", name:"pizza", x:620,y:205,calories:420},		
			
			{type:"block", name:"wood", x:720,y:380,angle:90,width:100,height:25},
			{type:"block", name:"glass", x:720,y:280,angle:90,width:100,height:25},								
			{type:"villain", name:"watermelon", x:720,y:205,calories:420},
